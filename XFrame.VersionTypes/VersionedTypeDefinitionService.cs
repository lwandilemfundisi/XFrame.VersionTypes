...
namespace XFrame.VersionTypes
{
        ...
        where TDefinition : VersionedTypeDefinition
    {
        ...
        private readonly ILogger<VersionedTypeDefinitionService<TTypeCheck, TAttribute, TDefinition>> _logger;
        ...
        protected VersionedTypeDefinitionService(
            ILogger<VersionedTypeDefinitionService<TTypeCheck, TAttribute, TDefinition>> logger)
        {
            _logger = logger;
        }
